...
function spawn.spectre {

 source items/spells/fireball.sh
 source items/spells/magicarrow.sh


 npc_name="Spectre"
 npc_source=spectre.sh
 npc_hp=46
 npc_hp_range=14
...
function npc.statmod {
 ...
 npc_attack_modifier=$[ $npc_strength + $npc_attack_range + $npc_intelligence_modifier ]
...
function npc_special_move_list {
 ...
 function npc_special2 {
  ...
  npc_special_stamina=8
  npc_special_name="Magic Arrow"
  function npc_special_flag2 {
   spell.magicarrow
   npc_skill_effect=$[ $npc_skill_magery / 2 ]
   npc_special_attack_total=$[ $spell_effect + $npc_skill_effect ]
   npc_skill_difference=$[ $npc_special_attack_total - $player_defense_total ]
